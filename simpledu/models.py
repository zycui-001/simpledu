...
class User(Base, UserMixin):
	...
	_passwprd = db.Column('password', db.String(256), nullable=False)
	...
	def password(self, orig_password):
		self._passwprd = generate_password_hash(orig_password)

	def check_password(self, password):
		return check_password_hash(self._passwprd, password)
